...
const TABELAS: TabelaModelo[] = [
  ...
  // --- PDI ---------------------------------------------------------------
  {
    ...
    campos: [
      ...
      { nome: 'lobId / cargoId', tipo: 'Int? / String?', nota: 'mutuamente exclusivos — de que LOB ou Cargo veio este item (classificação BUD/Sistema/Cargo Atual/Próximo Cargo no PDI, sempre ao vivo); a deduplicação ao gerar é sempre relativa à mesma LOB/Cargo — o mesmo gap visado por LOBs/Cargos diferentes (ex. Cargo Atual e Próximo Cargo, com níveis exigidos diferentes) gera linhas separadas' },
      { nome: 'nivelAlvoId', tipo: 'Int?', nota: '→ Nivel — nível a atingir na competência; obrigatório ao adicionar manualmente, null para itens de Certificação' },
      { nome: 'descricao', tipo: 'String' },
